class user_accounts {
    ...
    /*
        I pulled junck's user/key from the team's github repo so it might need to be changed
    */
	user { 'junck':
		ensure => present,
		managehome => true,
	...
	ssh_authorized_key { 'aziz94shh_key':
		name => 'aziz94shh',
		type => 'ssh-rsa',
